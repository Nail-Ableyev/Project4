...
//MECHANGE: used getElementsByClassName instead of querrySelectorAll()
...
//MECHANGE: created new variable scrollPizza to lighten for-loop
  ...
  //MECHANGE: converted pizzaPosition into integer 
  //divided by the half of the viewport and converted into string again
    var newPizzaPosition = (parseInt(pizzaPosition)-windowWidth/2).toString();
  //MECHANGE: used translateX() for better animation
    items[i].style.transform = 'translateX(' + newPizzaPosition + 'px' + ')';
  }
